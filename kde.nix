 
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-38eded43-50b3-479d-8ccf-ad398317e444" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."38eded43-50b3-479d-8ccf-ad398317e444" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "38eded43-50b3-479d-8ccf-ad398317e444";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{b71637e8-556a-4349-ad9b-9164c8fab11e}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{764f4722-660f-4180-b2c0-17a53a2c5451}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{c03ed6c1-aac5-4536-aab8-57ab1f558254}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{ddc2f212-223b-4913-91e6-bb92bf54c35a}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{eac59c39-44c5-4651-82d1-4b6299035936}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{f1fc34a8-75e2-4fef-973c-7203a2ed9919}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{c30bc469-b94b-4131-9700-9dcbf811e480}";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."FillMode" = 0;
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/home/kel/.local/share/wallpapers/moedark.png";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/home/kel/.local/share/wallpapers/moedark.png";
      "ksmserverrc"."General"."loginMode" = "emptySession";
      "ksplashrc"."KSplash"."Engine" = "none";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "1b1a490d-c50b-4c51-870a-2fd0598df8cf";
      ...
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."Description" = "Window settings for rog-control-center";
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."clientmachine" = "localhost";
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."ignoregeometry" = true;
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."ignoregeometryrule" = 3;
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."size" = "1200,900";
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."sizerule" = 2;
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."title" = "ROG Control Center";
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."titlematch" = 1;
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."types" = 1;
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."wmclass" = "rog-control-center";
      "kwinrulesrc"."046916f7-3c9f-41a8-a615-02fa0fc82363"."wmclassmatch" = 1;
      "kwinrulesrc"."1"."Description" = "Window settings for rog-control-center";
      "kwinrulesrc"."1"."clientmachine" = "localhost";
      "kwinrulesrc"."1"."ignoregeometry" = true;
      "kwinrulesrc"."1"."ignoregeometryrule" = 3;
      "kwinrulesrc"."1"."size" = "1200,900";
      "kwinrulesrc"."1"."sizerule" = 2;
      "kwinrulesrc"."1"."title" = "ROG Control Center";
      "kwinrulesrc"."1"."titlematch" = 1;
      "kwinrulesrc"."1"."types" = 1;
      "kwinrulesrc"."1"."wmclass" = "rog-control-center";
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."General"."count" = 1;
      "kwinrulesrc"."General"."rules" = 1;
      "plasma-localerc"."Formats"."LANG" = "en_AU.UTF-8";
      "plasmanotifyrc"."Notifications"."PopupTimeout" = 4000;
